...
For a standard network, set `--network <name>` or `KONA_SP1_PROPOSER_L2_NETWORK`
...
| `KONA_SP1_PROPOSER_L2_NETWORK` | Predefined network name recognized by OP Stack services, such as `op-mainnet`; alternative to `KONA_SP1_PROPOSER_FACTORY_ADDRESS` |
